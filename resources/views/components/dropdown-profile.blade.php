...
<div class="relative inline-flex" x-data="{ open: false }">
    ...
    >
        ...
        <div class="flex items-center truncate">
            <span class="hidden truncate ml-2 text-sm font-medium dark:text-slate-300 lg:block group-hover:text-slate-800 dark:group-hover:text-slate-200">{{ Auth::user()->name }}</span>
            <svg class="hidden w-3 h-3 shrink-0 ml-1 fill-current lg:block text-slate-400" viewBox="0 0 12 12">
