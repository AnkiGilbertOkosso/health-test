...
<head>
    ...
    <title>Wellbeacon - Manage your health</title>

    <!-- Meta SEO -->
    <meta name="title" content="Wellbeacon - Manage your health">
    ...
    <meta name="author" content="Wellbeacon">

    <!-- Social media share -->
    <meta property="og:title" content="Wellbeacon - Manage your health">
    <meta property="og:site_name" content="Wellbeacon">
    <meta property="og:url" content="#">
    <meta property="og:description" content="Take full control over your health and win today">
    <meta property="og:type" content="">
    <meta property="og:image" content="#">
    <meta name="twitter:card" content="summary" />
    <meta name="twitter:site" content="@Wellbeacon" />
    <meta name="twitter:creator" content="@Wellbeacon" />
...
<body>
            ...
            <div class="container flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                ...
                <div class="flex items-center space-x-2 lg:order-2">
                    <a href="{{ route('register') }}"
                        class="inline-block text-white bg-gradient-to-r from-purple-700 to-purple-800 hover:to-purple-900 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 dark:bg-gradient-to-r dark:from-purple-600 dark:to-purple-700 dark:hover:from-purple-700 dark:hover:to-purple-800 focus:outline-none dark:focus:ring-purple-800">Start
                        Today!</a>
                    <a href="{{ route('login') }}"
                        class="hidden lg:inline-block text-purple-700 border border-purple-700 hover:text-white hover:bg-purple-700 hover:border-purple-900 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 sm:mr-2 lg:mr-0 focus:outline-none dark:text-purple-300 dark:border-purple-300 dark:hover:text-white dark:hover:bg-purple-600 dark:hover:border-purple-900 dark:focus:ring-purple-800">Login</a>
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="#how-it-works"
                                class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">How
                                it works</a>
                        </li>
    ...
    <footer class="bg-white dark:bg-gray-800">
        <div class="container max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-4">
                ...
                <div>
                    <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Products</h3>
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="#" class=" hover:underline">Food</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Exercise</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Apps</a>
                        </li>
                        <li class="mb-4">
            ...
            <div class="text-center">
                ...
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024 Wellbeacon™. All
                    Rights Reserved.
                </span>
