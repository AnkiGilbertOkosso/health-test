<x-guest-layout>
    <div class="py-32 bg-gray-50">
        <div
            class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-lg shadow-gray-200 rounded-lg text-[#333] font-[sans-serif]">
            <div>
                ...
                <div class="mt-12">
                    ...
                    <ul class="mt-3">
                        <li class="flex items-center " width=" 20px" height="20px">
                            <div class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center hover:bg-purple-600 justify-center shrink-0">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" class="text-purple-800 hover:bg-purple-600 hover:text-white" fill='currentColor'
                            ...
                            <a target="blank" href="https://veilmail.io/e/FkKh7o" class="text-purple-600 text-sm ml-3">
                ...
                <div class="mt-12">
                    ...
                    <ul class="flex mt-3 space-x-4">
                        <li class="bg-[#e6e6e6cf] h-10 w-10 rounded-full flex items-center justify-center shrink-0 hover:bg-purple-600 hover:text-white">
